...
export default function Mapsection() {
  return (
    <div className="bg-[#f6f9fe] flex flex-col items-center justify-center py-12">
      {/* Main Row */}
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full px-4">
        
        {/* Left - Google Map */}
        <div className="flex flex-col items-center w-full max-w-[550px]">
          <div className="w-full h-[350px] border-2 border-[#1F2A44] rounded-md overflow-hidden">
            <iframe
          ...
          <a
            ...
            className="mt-4 px-6 py-3 bg-[#1a264f] text-white rounded-md hover:bg-[#13203f] transition"
          >
            VIEW LOCATION
          </a>
        </div>
